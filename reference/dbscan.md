...
clustering on them, with the possibility of separating amplitude and
phase variability and of choosing the source of variability through
which clusters should be searched.
...
- ...:
  ...
  [`frNN()`](https://rdrr.io/pkg/dbscan/man/frNN.html) for details on
  how to control the search strategy.
